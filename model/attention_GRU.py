...
import codecs
import theano
from nn.attention_GRU_net import Attention_GRU_Net
import numpy as np
...
class Attention_GRU(object):
    ...
    def initModel(self):
        ...
        self.model = Attention_GRU_Net(X_train=self.data['X_train'], C_train=self.data['C_train'],
                                      ...
                                      params_file=self.params_file, model_path=self.model_path
                                    )
            ...
            for batch in minibatches_iter(self.data['X_train'], self.data['Y_train'], masks=self.data['mask_train'],
                ...
                if train_batches > 0 and train_batches % self.valid_freq == 0:
                    ...
                    for batch in minibatches_iter(self.data['X_dev'], self.data['Y_dev'],
                        ...
                        inputs, targets, masks, char_inputs, lexicons = batch
                        accuracy_valid.append(self.model.eval_fn(inputs, targets, masks, char_inputs))
                    ...
                    if this_validation_accuracy > best_validation_accuracy:
                        ...
                        for batch in minibatches_iter(self.data['X_test'], self.data['Y_test'],
                            ...
                            accuracy_test.append(self.model.eval_fn(inputs, targets, masks, char_inputs))
